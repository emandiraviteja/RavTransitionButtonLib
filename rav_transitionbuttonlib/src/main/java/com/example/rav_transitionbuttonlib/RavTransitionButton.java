package com.example.rav_transitionbuttonlib;
...
import com.example.rav_transitionbuttonlib.utils.ColorUtils;
import com.example.rav_transitionbuttonlib.utils.WindowUtils;

/**
 * Created by Raviteja Emandi on 02,July,2025
 **/
public class RavTransitionButton  extends AppCompatButton {
    ...
    public RavTransitionButton(Context context) {
        super(context);
        init(context, null);
    }

    public RavTransitionButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RavTransitionButton(Context context, AttributeSet attrs, int defStyleAttr) {
